...
export function queryScopedCandidates(chunks, queryTerms) {
    ...
    for (const qw of queryTerms) {
        for (const idx of postingForPrefix.get(qw.slice(0, PREFIX_LEN)))
